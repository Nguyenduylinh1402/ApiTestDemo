...
public class ApiDemosTest extends UiAutomatorTestCase {
	...
	protected void setUp() throws Exception {
		...
		Logger.d(ApiDemosTest.class.getName(),
				"setUp click 'LogTextBox' menu item");
	 ...
	 */
	public void testLogTextBoxInitialStateButton()
			throws UiObjectNotFoundException {
		Logger.d(ApiDemosTest.class.getName(),
				"TEST : testing the initial state of the button");
	 ...
	 * @throws UiObjectNotFoundException
	 */
	public void testLogTextBoxInitialStateTextView()
			throws UiObjectNotFoundException {
		Logger.d(ApiDemosTest.class.getName(),
				"TEST : testing the initial state of the textview");
		final UiObject layout = new UiObject(new UiSelector().className(
				FrameLayout.class.getName()).index(1));
		final UiObject textview = layout.getChild(new UiSelector()
	 ...
	 * @throws UiObjectNotFoundException
	 */
	public void testLogTextBoxSingleClickedState()
			throws UiObjectNotFoundException {
		Logger.d(ApiDemosTest.class.getName(),
				"TEST : testing the single clicked state of the button");
