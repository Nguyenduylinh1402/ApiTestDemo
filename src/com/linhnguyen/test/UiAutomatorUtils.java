...
public class UiAutomatorUtils {
	...
	private final static UiObject findViewByText(final String text,
	...
	public static void clickOnTextView(final String text)
			throws UiObjectNotFoundException {
		new UiObject(new UiSelector().className(
				android.widget.TextView.class.getName()).text(text)).click();
	}

	public static void clickOnListViewItem(final String text)
			throws UiObjectNotFoundException {
		...
		final UiObject listViewItem = listView.getChildByText(new UiSelector()
	...
	public static void clickOnBackButton(final UiAutomatorTestCase test,
			int times) {
		while (times > 0) {
	...
	public final static void openApplication(final UiAutomatorTestCase test,
		...
		// make UI scrollable
		final UiScrollable appViews = new UiScrollable(
